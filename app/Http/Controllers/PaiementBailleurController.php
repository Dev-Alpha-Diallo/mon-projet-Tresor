   ...
   public function index()
{
    ...
    return view('paiements_bailleurs.index', compact('paiementsBailleurs'));
}
    ...
    public function create()
    {
        ...
        return view('paiements-bailleurs.create', compact('bailleurs', 'maisons'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('paiements-bailleurs.index')
     ...
     */
    public function edit(PaiementBailleur $paiementBailleur)
    {
        $bailleurs = Bailleur::orderBy('nom')->get();
        $maisons = Maison::orderBy('nom')->get();

        return view('paiements-bailleurs.edit', compact('paiementBailleur', 'bailleurs', 'maisons'));
    }
    ...
    public function show(PaiementBailleur $paiementBailleur)
    {
        ...
        return view('paiements-bailleurs.show', compact('paiementBailleur'));
    }
}
