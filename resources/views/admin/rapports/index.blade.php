...
<div class="space-y-6">
    ...
    <div class="glass-effect rounded-2xl p-6 border border-gray-200/50">
        ...
        <form action="{{ route('admin.rapports.generer') }}" method="POST" id="rapportForm" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <button type="submit" formaction="{{ route('admin.rapports.previsualiser') }}" formmethod="GET" formtarget="_blank" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('admin.rapports.telecharger', ['fichier' => $rapport['chemin']]) }}" 
