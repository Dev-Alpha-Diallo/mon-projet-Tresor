...
<div class="p-4">
    <!-- En-tête -->
    <div class="mb-6">
        <a href="{{ route('admin.maisons.index') }}" class="text-blue-600 hover:text-blue-800 text-sm flex items-center">
            ← Retour à la liste
        </a>
    ...
    <div class="bg-white rounded-lg border shadow-sm p-4">
        <form action="{{ route('admin.maisons.update', $maison) }}" method="POST">
            @csrf
            @method('PUT')
