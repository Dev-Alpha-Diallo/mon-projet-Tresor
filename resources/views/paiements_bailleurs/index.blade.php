...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('paiements-bailleurs.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                <a href="{{ route('paiements-bailleurs.edit', $paiement) }}" class="text-blue-600 hover:underline">
                                    Modifier
                                </a>
                                <form action="{{ route('paiements-bailleurs.destroy', $paiement) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr ?')">
                                    @csrf
                                    @method('DELETE')
