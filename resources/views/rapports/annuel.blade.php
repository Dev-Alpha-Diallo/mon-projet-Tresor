...
<body>
    <div class="header">
        ...
        <h2>Trésorerie Amicale Étudiante</h2>
    ...
    <div class="section">
        ...
        <table style="width: 60%;">
            ...
            <tr>
                ...
                <td style="text-align: right;" class="amount-positive">{{ $nombreCreatediteurs }} ({{ number_format($totalAvances, 0, ',', ' ') }} FCFA)</td>
            </tr>
            <tr class="chart-row">
                <td>Étudiants à jour :</td>
                <td style="text-align: right;">{{ $nombreEtudiants - $nombreDebiteurs - $nombreCreatediteurs }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        <div class="section-title">TOP 10 DÉBITEURS</div>
        <table>
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                @foreach($etudiantsDebiteurs->take(10) as $index => $etudiant)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $etudiant->nom }}</td>
    ...
    <div class="footer">
        <p><strong>© {{ date('Y') }} Trésorerie C.E.T</strong></p>
