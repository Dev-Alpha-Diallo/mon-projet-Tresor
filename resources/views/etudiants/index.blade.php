...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    ...
    <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="relative group">
            <button class="flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium rounded-lg shadow-sm transition-all duration-200 w-full sm:w-auto justify-center">
            ...
            <div class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <a href="{{ route('etudiants.export.tous', ['tri' => 'maison']) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-700">
                        <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                        Triée par maison
                    </a>
                    <a href="{{ route('etudiants.export.tous', ['tri' => 'nom']) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-700">
                        <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('etudiants.export.debiteurs') }}"
                ...
                <tbody>
                    ...
                    <tr class="border-t hover:bg-gray-50">
                        <td class="px-3 sm:px-4 py-3">
                            <a href="{{ route('etudiants.show', $etudiant) }}" class="text-blue-600 font-medium text-sm">
                                {{ $etudiant->nom }}
                            </a>
                        </td>
                    ...
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center">
                            ...
                            <a href="{{ route('etudiants.create') }}" class="inline-flex items-center justify-center space-x-2 px-4 py-2 mt-4 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-md hover:shadow-lg transition-all duration-200">
                                Ajouter un étudiant
                            </a>
                        </td>
                    </tr>
