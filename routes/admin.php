...
/*
|--------------------------------------------------------------------------
| Admin Routes (Protégées par authentification via web.php)
|--------------------------------------------------------------------------
*/
...
// API pour recherche asynchrone d'étudiants (utilisé par les formulaires lourds)
...
Route::get('/paiements-bailleurs/{paiement}/previsualiser', [PaiementBailleurController::class, 'previsualiser'])
    ->name('paiements-bailleurs.previsualiser');
